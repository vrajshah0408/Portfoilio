        ...
        <div className="flex flex-col items-center justify-center gap-8 text-center">
          ...
          <div>
            <p className="maz-w-xs md:max-w-lg font-extralight">
              I am open to do full-time positions. You are open to contact me
              using your preferred medium.
            </p>
          </div>
          ...
          <div className="p-8 text-left w-full">
            <form
              action="https://getform.io/f/a6a831d8-0d83-4787-9ea1-7ef9d4ac3770"
              method="POST"
            >
